...
using vendor::lmodroid::biometrics::fingerprint::inscreen::V1_0::IFingerprintInscreen;
using vendor::lmodroid::biometrics::fingerprint::inscreen::V1_0::implementation::FingerprintInscreen;
